...
enum AppError: Error, CustomStringConvertible {
    ...
    case networkFailed(url: URL, underlying: String?)
    case decodingFailed(typeName: String, url: URL, underlying: Error)

    case cacheDirectoryCreationFailed(url: URL, underlying: Error)
    case cacheReadFailed(url: URL, underlying: URL)
    case cacheWriteFailed(url: URL, underlying: URL)
    case cacheDeleteFailed(url: URL, underlying: URL)
